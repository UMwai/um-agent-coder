...
Respond ONLY with valid JSON, no markdown."""
        ...
        "data_sources": [
            {
                "name": "sec_edgar",
                "type": "api",
                "description": "SEC filings for financial data",
            ...
            },
            {
                "name": "clinicaltrials",
                "type": "api",
                "description": "Clinical trial status and results",
            ...
            },
            {
                "name": "yahoo_finance",
                "type": "api",
                "description": "Stock prices, market cap, financials",
            ...
            },
            {
                "name": "pubmed",
                "type": "api",
                "description": "Scientific publications and citations",
    ...
    def _build_decomposed_task(self, original_prompt: str, data: dict) -> DecomposedTask:
        ...
        for st in data.get("subtasks", []):
            ...
            st_data_sources = [ds for ds in data_sources if ds.name in st.get("data_sources", [])]
    ...
    def visualize(self, task: DecomposedTask) -> str:
        ...
        lines.extend(["", f"Estimated tokens: {task.estimated_total_tokens:,}", "=" * 60])
