            ...
            "attachments": [
                {
                    ...
                    "fields": [
                        ...
                        {"title": "Progress", "value": f"{update.progress_pct:.0f}%" if update.progress_pct else "N/A", "short": True},
                    ]
                }
            ]
        }
        ...
        payload = {
            "embeds": [{
                ...
                "fields": [
                    ...
                    {"name": "Progress", "value": f"{update.progress_pct:.0f}%" if update.progress_pct else "N/A", "inline": True},
                ],
...
class TaskSpec:
    ...
    def __post_init__(self):
        ...
        if any([self.webhook_url, self.slack_webhook, self.discord_webhook, self.n8n_webhook, self.on_update]):
