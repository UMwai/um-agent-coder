...
def main():
    ...
    api_key_vars = {"openai": "OPENAI_API_KEY", "anthropic": "ANTHROPIC_API_KEY", "google": "GOOGLE_API_KEY"}
    ...
    if args.command == "start":
        ...
        for job in jobs:
            ...
            print(f"{job.job_id:<10} | {job.status:<10} | {job.current_step_index}/{total:<5} | {prompt_preview}")
